...
const a = [0,undefined, '53565', null, person2];
console.log(a);
...
// slice 
const avengers = ['美国队长', '钢铁侠', '雷神', '绿巨人'];
const b = avengers.slice(1,3);
console.log(b)
console.log(avengers)

// splice
const avengers = ['美国队长', '钢铁侠', '雷神', '绿巨人'];
const c = avengers.splice(1,2,'wjm',2,3)
console.log(c);
console.log(avengers);
...
// 多维数组
const ma = [[1,2],[3,4]];
console.log(ma[0][1]); //第一个数组中第二个的值
